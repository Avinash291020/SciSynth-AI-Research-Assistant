            ...
            for j in range(i + 1, min(i + 5, len(lines))):
                ...
                if author_line and len(author_line) > 10:
                    ...
                    if re.search(r'[A-Z][a-z]+\s+[A-Z][a-z]+', author_line):
                        ...
                        names_part = re.split(r'\d|\(|\[|Department|University|Institute', author_line)[0]
...
def extract_sections(insights):
    ...
    for line in lines:
        ...
        elif line.lower() in ['abstract', 'introduction', 'conclusion', 'references', 'bibliography', 'methodology', 'results', 'discussion']:
            sections.append(line)
