...
def demo_advanced_nlp():
    ...
    try:
        ...
        sample_papers = rag.retrieve_relevant_papers(
            "language models neural networks", top_k=5
        )
        ...
        print("\n📊 NLP Patterns Used:")
        print(
            "- Strength patterns: improve, outperform, robust, advantage, effective, etc."
        )
        print(
            "- Weakness patterns: limitation, fail, struggle, drawback, require more, etc."
        )
