...
def verify_ai_capabilities():
    ...
    capabilities = {
        ...
        "Evolutionary Algorithms": [
            "evolutionary/evolve_hypotheses.py"
        ],
        "LLM": [
            "app/model_cache.py",
            "app/hypothesis_gen.py"
    ...
    for capability, files in capabilities.items():
        ...
        print(f"📋 {capability}: {'✅ IMPLEMENTED' if capability_status else '❌ INCOMPLETE'}")
        print("-" * 40)
    ...
    print(f"🎯 Capabilities: {implemented}/{total_capabilities} ({implemented/total_capabilities*100:.1f}%)")
